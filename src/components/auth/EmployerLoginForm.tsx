...
export type EmployerLoginValues = z.infer<typeof loginSchema>;

interface EmployerLoginFormProps {
  onSuccess?: () => void;
}

export const EmployerLoginForm = ({ onSuccess }: EmployerLoginFormProps) => {
  ...
  const onSubmit = (values: EmployerLoginValues) => {
    console.log("Login values:", values, "User type: employer");
